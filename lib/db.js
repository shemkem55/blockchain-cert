// Database connection for production deployment
// Note: Local SQLite files may not persist on all hosting platforms
...
export async function connectDB() {
  try {
    ...
    if (DB_TYPE === 'mysql' || DB_TYPE === 'mariadb') {
      ...
      console.warn('⚠️ SQLite might not be supported on this platform. Please configure a hosted database.');
      return false;
    }
  } catch (error) {
...
// Database models (simplified for production deployment)
export class User {
