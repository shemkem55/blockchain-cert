    ...
    return (
        <section className="container mx-auto px-4 py-20">
            <div className="flex justify-between items-end mb-12">
                ...
                <Link
                    to="/news"
                    className="hidden md:flex items-center gap-2 text-sm font-black uppercase tracking-widest text-primary hover:text-primary/80 transition-colors"
                >
                    View All News
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {newsItems.map((item, index) => (
                    <motion.article
                        ...
                        className="glass p-6 rounded-lg border-2 border-white/5 hover:border-primary/40 transition-all group cursor-pointer"
                    >
                        ...
                        <h3 className="text-lg font-black mb-3 leading-tight group-hover:text-primary transition-colors">
                            {item.title}
                        </h3>
            ...
            <div className="mt-8 text-center md:hidden">
                <Link
                    to="/news"
                    className="inline-flex items-center gap-2 text-sm font-black uppercase tracking-widest text-primary hover:text-primary/80 transition-colors"
                >
                    View All News
                    <ArrowRight className="h-4 w-4" />
                </Link>
